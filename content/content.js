if (!window.hasRun) {
  ...
  function updateInputBox() {
    chrome.storage.sync.get("redactSettings", function (items) {
      ...
      previewBox = previewBox || document.querySelector("#previewBox");
      if (!previewBox) {
      ...
      toggleButton = toggleButton || document.querySelector("#toggleButton");
      if (!toggleButton) {
      ...
      tokenCountElement =
        tokenCountElement || document.querySelector("#tokenCount");
